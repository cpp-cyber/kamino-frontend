...
import TemplateImageDropzoneWithCropper from "@/components/templates/publish-wizard/image-dropzone-with-cropper";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Supports Markdown formatting including **bold**, *italic*, `code`,
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-sm text-muted-foreground">
              Specify the authors or creators of this template (max 255
              characters).
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-sm text-muted-foreground">
              Upload a new image for your template (max 10MB). Leave empty to
              keep current image.
            </p>
          </div>
