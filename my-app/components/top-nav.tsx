  ...
  const getActiveState = (link: NavigationLink) => {
    if (link.children) {
      return link.children.some(
        (child: NavigationChild) => pathname === child.href,
      );
    }
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8 lg:px-16 xl:px-24">
        <div className="flex h-16 justify-between gap-4">
          ...
          <div className="flex gap-2">
            <div className="flex items-center md:hidden">
              ...
              <Popover>
                ...
                <PopoverContent
                  align="start"
                  className="w-37 p-1 md:hidden bg-background border-0 rounded-none rounded-b-lg shadow-lg mt-3"
                >
                  <NavigationMenu>
                      ...
                      return (
                        <NavigationMenuItem key={index} className="h-full">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent
                              align="start"
                              className="-mt-1 bg-background border-0 rounded-none rounded-b-lg"
                            >
          ...
          <div className="flex items-center gap-2">
            {authState.isAdmin && (
              <>
                <Button
                  variant="ghost"
                  asChild
                  className="flex items-center gap-2 px-3 py-2 h-auto bg-gradient-to-r from-kamino-green to-kamino-yellow font-medium hover:brightness-90 cursor-pointer shadow-md text-white hover:text-white"
                >
            ...
            {authState.isCreator && !authState.isAdmin && (
              <>
                <Button
                  variant="ghost"
                  asChild
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="flex items-center gap-2 px-3 py-4 h-auto"
                >
              ...
              <DropdownMenuContent
                align="end"
                className="w-28 bg-background border-0 rounded-none rounded-b-lg"
              >
                <DropdownMenuItem
