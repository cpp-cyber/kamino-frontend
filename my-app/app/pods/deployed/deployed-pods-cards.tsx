...
import { CalendarIcon, Trash, User, Cpu, HardDrive, MemoryStick, Clock, Boxes } from "lucide-react"
import Image from "next/image"
import { DeployedPod } from "@/lib/types"
import { formatUptime, formatBytes, calculateUtilization, cn, formatPodName } from "@/lib/utils"
        ...
        return (
          <div key={pod.name || index}>
            ...
            <Card className="overflow-hidden border bg-gradient-to-br from-primary/5 to-muted/5 border-primary/20 shadow-lg">
                  ...
                  <div className="flex-1 flex flex-col justify-center space-y-3">
                    ...
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      ...
                      <span className="font-medium">
                        Published {pod.template?.created_at ? new Date(pod.template.created_at).toLocaleDateString(undefined, {
                          year: "numeric",
                          month: "long",
                          day: "numeric",
              ...
              {/* Main content */}
              <Accordion type="multiple" defaultValue={["vms", "description"]} className="space-y-4">
                            ...
                            <CardHeader>
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <IconCircleFilled 
                                    className={cn(
                                      ...
                                      vm.status === 'stopped' ? 'text-red-400' : 
                                      'text-yellow-400'
                                    )} 
                                  />
                                ...
                                <Badge 
                                  ...
                                  className={cn(
                                    "font-medium",
                                    vm.status === 'running' && 'border-green-400/40',
                                    vm.status === 'stopped' && 'border-red-400/40'
                                  )}
                                >
                                  <Clock />
                            ...
                            <CardContent className="pt-0">
                              <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Progress 
                                    value={vm.mem && vm.maxmem ? calculateUtilization(vm.mem, vm.maxmem) : 0} 
                                    className="h-2"
                                  />
                                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {pod.template?.authors ? (
                      ...
                      <p className="text-sm text-muted-foreground italic">No authors specified</p>
                    )}
                  </div>
                </div>
              </div>
