        ...
        {vms.length === 0 && (
          <TableRow key="empty-state">
            <TableCell colSpan={10} className="text-center py-8 text-muted-foreground">
              {searchTerm ? 'No VMs found matching your search.' : 'No VMs found.'}
            </TableCell>
          </TableRow>
        )}
        {vms.map((vm) => (
          <TableRow key={`${vm.vmid}-${vm.node}`} className="hover:bg-muted/50">
            <TableCell className="font-mono text-sm">
              <div className="truncate text-muted-foreground px-2">{vm.vmid}</div>
            </TableCell>
            <TableCell className="font-mono text-sm">
            ...
            <TableCell>
              <div className="truncate text-muted-foreground">{vm.pool || 'N/A'}</div>
            </TableCell>
            <TableCell>
            ...
            <TableCell>
              <div className="truncate text-muted-foreground">{formatBytes(vm.maxdisk)}</div>
            </TableCell>
            <TableCell>
              <StatusBadge status={vm.status} />
            </TableCell>
            <TableCell>
              <div className="truncate text-muted-foreground">{formatUptime(vm.uptime)}</div>
            </TableCell>
            <TableCell>
              <DropdownMenu>
