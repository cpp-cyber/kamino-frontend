    ...
    <>
      <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid gap-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs grid-cols-3 pb-2">
        ...
        <ManageGroupMembersDialog
          onMembersUpdated={onGroupCreated}
          trigger={
            <Button
              className="h-full bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-md  hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center gap-2"
              type="button"
            >
              <UserCog2 />
              Manage Members
